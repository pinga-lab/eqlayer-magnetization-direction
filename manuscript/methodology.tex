...
\begin{equation}
   ...
   \label{eq:phi}
 \end{equation}
where $r = [(x-x')^2 + (y-y')^2 + (z-z_c)^2]^{1/2}$. The $\hat{\mathbf{h}}(\mathbf{q})$ is a unit vector with the magnetization direction of the layer given by 
...
and $\mathbf{q}$ is a vector with components given by 
 ...
 \begin{equation}
   ...
   \label{eq:q_vector}
 \end{equation}
 where $i$ and $d$ is the inclination and declination of magnetization of the layer, respectively.
